...
module.exports.forgotEmailLinkTemplate= function(link,name){

  let forgotEmailTemplateHtml=`<!DOCTYPE html>
  <html lang="en">
      <head>
          <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
          <meta http-equiv="X-UA-Compatible" content="IE=edge">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>MongoCrudPorject</title>
          <style type="text/css">
            @font-face {
                    ...
                    <td style="padding-top:0;padding-bottom:0;padding-right:30px;padding-left:30px;text-align:center;Margin-right:auto;Margin-left:auto;">
                      <center>
                        <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;font-size:15px;color:#a1a8ad;line-height:23px;">Problems or questions? Call us at
                          <nobr><a class="tel" href="tel:2128102899" style="color:#a1a8ad;text-decoration:none;" target="_blank"><span style="white-space: nowrap">9998887776</span></a></nobr>
                        </p>
        
                        <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;font-size:15px;color:#a1a8ad;line-height:23px;">or email <a href="mailto:pitchgooglid@gmail.com" style="color:#a1a8ad;text-decoration:underline;" target="_blank">pitchgooglid@gmail.com</a></p>
        
                        <p style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;padding-top:10px;padding-bottom:0px;font-size:15px;color:#a1a8ad;line-height:23px;">© Engineer Master's <span style="white-space: nowrap">19-A Electronic Complex </span>, <span style="white-space: nowrap">MPSEDC IT Park, Indore,</span> <span style="white-space: nowrap">Madhya Pradesh 452010</span></p>
                      </center>
                    </td>
                  </tr>
                  <!-- whitespace -->
  ...
  `
  return forgotEmailTemplateHtml;
}
